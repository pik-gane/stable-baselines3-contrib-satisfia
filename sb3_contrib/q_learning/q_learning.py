...
from sb3_contrib.q_learning.policies import QLearningPolicy, QTable
    ...
    def learn(
        ...
        while self.num_timesteps < total_timesteps:
            ...
            with th.no_grad():
                ...
                self.logger.record_mean("train/mean_q_loss", float(F.mse_loss(self.q_table(obs, action), q_target).mean()))
                self.q_table.update_table(obs, action, q_target, learning_rate)
            obs = new_obs
